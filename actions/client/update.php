...
if (isset($_POST['submit_btn']) && $_POST['submit_btn'] == "clientEdit") {
	...
	if ($conn) {
		...
		$sql1 = "UPDATE clients,addresses SET clients.firstname='$fname', clients.lastname='$lname', clients.gender='$gender', clients.contact='$cont', addresses.street_no='$street', addresses.town='$town', addresses.city='$city', addresses.state='$state' WHERE clients.add_id=addresses.add_id AND clients.cid=$cid";
		...
		if ($result) {
			...
			header("Location: /?type=client&edit=true");
