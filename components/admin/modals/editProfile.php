<div class="container">
	<!-- Modal -->
	  <div class="modal fade" tabindex="-1" id="adminEditProfileModal" role="dialog">
	    <div class="modal-dialog">
	      ...
	      <div class="modal-content">
	        ...
	        <div class="modal-body">
	          <form role="form" action="actions/admin/update.php" method="post">
              ...
              <div class="row">
				...
				<label for="add"><i class="fa fa-fw fa-map-marker"></i> Address</label>
				<div class="row">
					<div class="col-md-6 form-group">
	            ...
	            <button type="submit" class="btn btn-default btn-success btn-block" name="submit_btn" value="adminEdit"><span class="fa fa-fw fa-check"></span> Submit</button>
	          </form>
	        </div>
	        <div class="modal-footer">
	          <button type="submit" class="btn btn-danger btn-default pull-left" data-dismiss="modal"><i class="fa fa-fw fa-remove"></i> Cancel</button>
  	          <!-- <p>Not a member? <a id="signupButton2">Sign Up</a></p> -->
